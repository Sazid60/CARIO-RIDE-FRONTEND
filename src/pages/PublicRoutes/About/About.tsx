...
export default function About() {
    ...
    const heading = "Team"
    const description = "Meet the dedicated team driving Cario-Ride from engineering our platform to supporting our riders and drivers."
    ...
    const members = [
        {
            ...
            description: "Visionary leader driving Cario-Ride’s strategy, partnerships, and overall growth."
        },
        {
            id: "member-2",
            name: "Rafiq Hossain",
                        ...
                        {members.map((member) => (
                            ...
                            >
                                ...
                                <CardContent className="text-center">
                                    <h3 className="text-md sm:text-lg font-bold uppercase group-hover:text-primary transition-colors">{member.name}</h3>
